#!/bin/bash
# ContaHub — Atualiza ClientModal com suporte PJ/PF + consulta CNPJ automática
# Execute na raiz do projeto: bash atualizar-modal-cliente.sh
...
echo "✅ ClientModal atualizado com sucesso!"
echo ""
echo "Novidades:"
echo "  - Toggle PJ / PF"
echo "  - Consulta automática de CNPJ via BrasilAPI"
echo "  - Preenchimento automático de nome, endereço e regime"
echo "  - CPF obrigatório para PF, opcional para MEI"
echo "  - Máscara de CNPJ e CPF em tempo real"
echo "  - Observações"
